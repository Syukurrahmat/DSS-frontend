import { trimAndCleanProps } from '@/lib/common.utils';
...
import { BigAlert } from '@/components/display/BigAlert';
import { MyRadio } from '@/components/input/MyRadio';
				...
				{status !== undefined ? (
					...
					<form onSubmit={handleSubmit} className="my-form">
						<VStack mx="auto" spacing="2">
							...
							<FormControl isInvalid={Boolean(errors.role) && touched.role}>
								<FormLabel>
							...
							<FormControl
								isInvalid={Boolean(errors.profilePicture) && touched.profilePicture}
							>
