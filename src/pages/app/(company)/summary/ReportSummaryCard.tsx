...
import { RatingIconList } from '../../(core)/complaints/ReportCard';
					...
					<Flex gap="4" direction={screenType == 'desktop' ? 'row' : 'column'}>
						<VStack flex="1 1 0" align="stretch">
							<Alert
								...
								as={VStack}
							>
								<HStack fontWeight="600" fontSize="md" alignSelf="start">
							...
							<Text fontWeight="600">Jumlah aduan berdasarkan bintang</Text>
							<Grid
								w="full"
								gap="2"
						...
						<MapView
							...
							nodesData={reports.filter((e) => (filter ? e.rating == filter : true))}
						/>
					</Flex>
				) : (
